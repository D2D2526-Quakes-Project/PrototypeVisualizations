...
- [x] Honor hinge `endMask` when rendering end caps so one-sided hinge rows do not request nonexistent J-side values
...
- [x] Generalize the floor displacement panel into a multi-select floor metric chart
