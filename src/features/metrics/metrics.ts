...
export const METRIC_PALETTES: Record<MetricPaletteKey, MetricPaletteDefinition> = {
  red: {
    ...
    positiveThresholdColorStops: [TAILWIND_PALETTES.red[600], TAILWIND_PALETTES.red[950]],
    negativeColorStops: [TAILWIND_PALETTES.red[50], TAILWIND_PALETTES.red[400]],
    negativeThresholdColorStops: [TAILWIND_PALETTES.red[600], TAILWIND_PALETTES.red[950]],
  ...
  rose: {
    ...
    positiveThresholdColorStops: [TAILWIND_PALETTES.rose[600], TAILWIND_PALETTES.rose[950]],
    negativeColorStops: [TAILWIND_PALETTES.rose[50], TAILWIND_PALETTES.rose[400]],
    negativeThresholdColorStops: [TAILWIND_PALETTES.rose[600], TAILWIND_PALETTES.rose[950]],
  ...
  orange: {
    ...
    positiveThresholdColorStops: [TAILWIND_PALETTES.orange[600], TAILWIND_PALETTES.orange[950]],
    negativeColorStops: [TAILWIND_PALETTES.orange[50], TAILWIND_PALETTES.orange[400]],
    negativeThresholdColorStops: [TAILWIND_PALETTES.orange[600], TAILWIND_PALETTES.orange[950]],
  ...
  amber: {
    ...
    positiveThresholdColorStops: [TAILWIND_PALETTES.amber[600], TAILWIND_PALETTES.amber[950]],
    negativeColorStops: [TAILWIND_PALETTES.amber[50], TAILWIND_PALETTES.amber[400]],
    negativeThresholdColorStops: [TAILWIND_PALETTES.amber[600], TAILWIND_PALETTES.amber[950]],
  ...
  green: {
    ...
    positiveThresholdColorStops: [TAILWIND_PALETTES.green[600], TAILWIND_PALETTES.green[950]],
    negativeColorStops: [TAILWIND_PALETTES.green[50], TAILWIND_PALETTES.green[400]],
    negativeThresholdColorStops: [TAILWIND_PALETTES.green[600], TAILWIND_PALETTES.green[950]],
  ...
  blue: {
    ...
    positiveThresholdColorStops: [TAILWIND_PALETTES.blue[600], TAILWIND_PALETTES.blue[950]],
    negativeColorStops: [TAILWIND_PALETTES.blue[50], TAILWIND_PALETTES.blue[400]],
    negativeThresholdColorStops: [TAILWIND_PALETTES.blue[600], TAILWIND_PALETTES.blue[950]],
  ...
  cyan: {
    ...
    positiveThresholdColorStops: [TAILWIND_PALETTES.cyan[600], TAILWIND_PALETTES.cyan[950]],
    negativeColorStops: [TAILWIND_PALETTES.cyan[50], TAILWIND_PALETTES.cyan[400]],
    negativeThresholdColorStops: [TAILWIND_PALETTES.cyan[600], TAILWIND_PALETTES.cyan[950]],
  ...
  teal: {
    ...
    positiveThresholdColorStops: [TAILWIND_PALETTES.teal[600], TAILWIND_PALETTES.teal[950]],
    negativeColorStops: [TAILWIND_PALETTES.teal[50], TAILWIND_PALETTES.teal[400]],
    negativeThresholdColorStops: [TAILWIND_PALETTES.teal[600], TAILWIND_PALETTES.teal[950]],
  ...
  violet: {
    ...
    positiveThresholdColorStops: [TAILWIND_PALETTES.violet[600], TAILWIND_PALETTES.violet[950]],
    negativeColorStops: [TAILWIND_PALETTES.violet[50], TAILWIND_PALETTES.violet[400]],
    negativeThresholdColorStops: [TAILWIND_PALETTES.violet[600], TAILWIND_PALETTES.violet[950]],
  ...
  purple: {
    ...
    positiveThresholdColorStops: [TAILWIND_PALETTES.purple[600], TAILWIND_PALETTES.purple[950]],
    negativeColorStops: [TAILWIND_PALETTES.purple[50], TAILWIND_PALETTES.purple[400]],
    negativeThresholdColorStops: [TAILWIND_PALETTES.purple[600], TAILWIND_PALETTES.purple[950]],
    keyColor: TAILWIND_PALETTES.purple[500],
  },
  viridis: {
    label: "Viridis",
    paletteKey: "viridis",
    positiveColorStops: [MATPLOTLIB_PALETTES.viridis[0], MATPLOTLIB_PALETTES.viridis[1]],
    positiveThresholdColorStops: [MATPLOTLIB_PALETTES.viridis[3], MATPLOTLIB_PALETTES.viridis[4]],
    negativeColorStops: [MATPLOTLIB_PALETTES.viridis[0], MATPLOTLIB_PALETTES.viridis[1]],
    negativeThresholdColorStops: [MATPLOTLIB_PALETTES.viridis[3], MATPLOTLIB_PALETTES.viridis[4]],
    keyColor: MATPLOTLIB_PALETTES.viridis[2],
  },
  plasma: {
    label: "Plasma",
    paletteKey: "plasma",
    positiveColorStops: [MATPLOTLIB_PALETTES.plasma[0], MATPLOTLIB_PALETTES.plasma[1]],
    positiveThresholdColorStops: [MATPLOTLIB_PALETTES.plasma[3], MATPLOTLIB_PALETTES.plasma[4]],
    negativeColorStops: [MATPLOTLIB_PALETTES.plasma[0], MATPLOTLIB_PALETTES.plasma[1]],
    negativeThresholdColorStops: [MATPLOTLIB_PALETTES.plasma[3], MATPLOTLIB_PALETTES.plasma[4]],
    keyColor: MATPLOTLIB_PALETTES.plasma[2],
  },
  inferno: {
    label: "Inferno",
    paletteKey: "inferno",
    positiveColorStops: [MATPLOTLIB_PALETTES.inferno[0], MATPLOTLIB_PALETTES.inferno[1]],
    positiveThresholdColorStops: [MATPLOTLIB_PALETTES.inferno[3], MATPLOTLIB_PALETTES.inferno[4]],
    negativeColorStops: [MATPLOTLIB_PALETTES.inferno[0], MATPLOTLIB_PALETTES.inferno[1]],
    negativeThresholdColorStops: [MATPLOTLIB_PALETTES.inferno[3], MATPLOTLIB_PALETTES.inferno[4]],
    keyColor: MATPLOTLIB_PALETTES.inferno[2],
  },
  magma: {
    label: "Magma",
    paletteKey: "magma",
    positiveColorStops: [MATPLOTLIB_PALETTES.magma[0], MATPLOTLIB_PALETTES.magma[1]],
    positiveThresholdColorStops: [MATPLOTLIB_PALETTES.magma[3], MATPLOTLIB_PALETTES.magma[4]],
    negativeColorStops: [MATPLOTLIB_PALETTES.magma[0], MATPLOTLIB_PALETTES.magma[1]],
    negativeThresholdColorStops: [MATPLOTLIB_PALETTES.magma[3], MATPLOTLIB_PALETTES.magma[4]],
    keyColor: MATPLOTLIB_PALETTES.magma[2],
  },
  cividis: {
    label: "Cividis",
    paletteKey: "cividis",
    positiveColorStops: [MATPLOTLIB_PALETTES.cividis[0], MATPLOTLIB_PALETTES.cividis[1]],
    positiveThresholdColorStops: [MATPLOTLIB_PALETTES.cividis[3], MATPLOTLIB_PALETTES.cividis[4]],
    negativeColorStops: [MATPLOTLIB_PALETTES.cividis[0], MATPLOTLIB_PALETTES.cividis[1]],
