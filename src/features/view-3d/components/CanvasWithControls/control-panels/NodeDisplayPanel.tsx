    ...
    <div className="space-y-1">
      ...
      <div className="flex items-center gap-2">
        ...
        <Slider
          ...
          className="flex-1"
        />
        <span className="w-10 shrink-0 text-right text-[10px] text-neutral-500">{belowThresholdNodeScale.toFixed(1)}x</span>
      </div>
      ...
      {renderHingeNodes && (
        <div className="flex items-center gap-2">
          ...
          <Slider
            ...
            className="flex-1"
          />
          <span className="w-10 shrink-0 text-right text-[10px] text-neutral-500">{belowThresholdHingeScale.toFixed(1)}x</span>
        </div>
      )}
    </div>
  );
