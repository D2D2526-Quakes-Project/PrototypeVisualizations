...
export function PeakValuesPanel() {
  ...
  const { peakNodeDisplacement, peakNodeDisplacementFrame, peakNodeDisplacementX, peakNodeDisplacementY, peakNodeDisplacementZ } = precomputed;
  ...
  const peakData = useMemo(() => {
    ...
    return peaks;
  }, [nodeCount, peakNodeDisplacement, peakNodeDisplacementFrame, peakNodeDisplacementX, peakNodeDisplacementY, peakNodeDisplacementZ]);
